    ...
    <form action="{{ route('complaints.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
        ...
        <div class="bg-white rounded-lg shadow p-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Judul Pengaduan <span class="text-red-500">*</span></label>
        ...
        <div class="bg-white rounded-lg shadow p-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="location_name" id="location_name" value="{{ old('location_name') }}" required
                    placeholder="Contoh: Jl. Sudirman No.10, Yogyakarta"
