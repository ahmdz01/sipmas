...
<div class="max-w-lg bg-white rounded-lg shadow p-6">
    <h2 class="font-semibold text-gray-700 mb-5">Edit Kategori</h2>
    ...
    <form method="POST" action="{{ route('admin.categories.update', $category->id) }}" class="space-y-4">
        ...
        <div>
            ...
            <div class="flex items-center gap-3">
                <input type="color" name="color" id="color-input" value="{{ old('color', $category->color) }}"
        ...
        <div class="border rounded-lg p-4 flex items-center gap-3 bg-gray-50">
            ...
            <span id="preview-badge" class="w-10 h-10 rounded-full flex items-center justify-center"
                ...
                <i id="preview-icon" class="fas fa-{{ $category->icon }}"></i>
            </span>
        </div>
